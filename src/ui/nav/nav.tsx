...
export const Nav = async () => {
	return (
		<header className="z-50 py-4 sticky top-0 bg-white/90 backdrop-blur-xs nav-border-reveal sm:h-[var(--header-height)]">
			<div className="mx-auto flex max-w-7xl items-center gap-2 px-4 flex-row sm:px-6 lg:px-8">
				...
				<CartSummaryNav />
				<YnsLink href="/login" className="hidden sm:block">
